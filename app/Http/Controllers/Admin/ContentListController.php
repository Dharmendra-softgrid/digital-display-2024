...
class ContentListController extends Controller
{
    public function index(Request $request) {
        $data['contents'] = Content::where('page', $request->input('type'))->orderBy('id', 'DESC')->paginate(15);
        return view('admin.contentList.index',$data);
    }
    public function create() {
        ...
        return view('admin.contentList.form',$data);
    }
