...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('click', '.addspecBr', function() {
                ...
                var spec = `
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-3"><input type="file" name="pdf_files[${variantId}][]" multiple class="form-control"></div>
            ...
            // Function to remove a specification component within a tab
            $(document).on('click', '.deletecomp', function() {
                $(this).closest('.row')
                    .remove(); // Remove the parent row containing the specification component
            });
    ...
    <script>
        $(document).ready(function() {
            ...
            function addTab(tabId, tabTitle, variantId, isActive) {
                ...
                var tabContent = `
                    <div class="tab-pane fade ${activePaneClass}" id="${tabId}">
                        ...
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Product Component</label>
                            <div class="col-sm-10">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row comp-container">
                                            <div class="col-sm-12">
                                                <button type="button" style="margin-bottom: 5px;" class="btn btn-primary btn-sm float-end addspeccomp mt-3"><i class="bi bi-plus"></i> Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row brochures-container">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row mt-2 brochures-section">
                                                        <label for="inputNumber" class="col-sm-2 col-form-label">Upload PDF</label>
                                                        <div class="col-sm-3">
                                                            <input type="file" name="pdf_files[${variantId}][]" multiple class="form-control">
                                                        </div>
                                                        <label for="inputNumber" class="col-sm-2 col-form-label">Name</label>
                                                        <div class="col-sm-3">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="card">
                                                        <input type="hidden" name="brochures_id[]" value="">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="key_features[${variantId}][]" class="form-control content" id="content"></textarea>
                                </div>
                            </div>
                        </div>`;
            ...
            function handleDropdownChange() {
                ...
                if (selectedOptions) {
                    ...
                    $.each(selectedOptions, function(index, value) {
                        ...
                        if (isActive) {
                            selectedVariantId = variantId; // Store the selected variant ID only when page loads
                        }
                    });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.length === 0) {
                            // If no data, show empty input boxes
                            data = `
                                <div class="col-sm-12">
                                    <button type="button" style="margin-bottom: 5px;" class="btn btn-primary btn-sm float-end addspeccomp mt-3"><i class="bi bi-plus"></i> Add</button>
                                </div>
                            ...
                            $.each(response, function(index) {
                                data += `
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-sm-3">
                                            <label for="inputType" class="col-form-label">Component Type</label>
                                            <input type="text" name="component_type[${variantId}][]" class="form-control autocomplete" value="${response[index].component_type}">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="inputName" class="col-form-label">Component Name</label>
                                            <input type="text" name="component_name[${variantId}][]" class="form-control autocomplete" value="${response[index].component_name}">
                                        </div>
                                        <div class="col-sm-4">
                                            <label for="inputValue" class="col-form-label">Component Value</label>
                                            <input type="text" name="component_specification[${variantId}][]" class="form-control autocomplete" value="${response[index].component_specification}">
                                        </div>
                                        <div class="col-sm-2" style="margin-top:40px;">
                                            <button type="button" class="btn btn-danger btn-sm float-end deletecomp"><i class="bi bi-trash"></i></button>
                                        </div>
            ...
            $(document).on('click', '.addspeccomp', function() {
                var $parentTabPane = $(this).closest('.tab-pane');
                var variantId = $parentTabPane.find('input[name="v_id[]"]').val(); // Get the variant ID from the hidden input field
                var comp = `
                    <div class="row mt-2">
                        <div class="col-sm-3">
                            <label for="inputType" class="col-form-label">Component Type</label>
