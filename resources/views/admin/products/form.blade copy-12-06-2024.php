    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.nav-link', function() {
                ...
                // Call fetch functions with productId and variantId
            ...
            $(document).on('click', '.addspeccomp', function() {
                var $parentTabPane = $(this).closest('.tab-pane');
                var variantId = $parentTabPane.find('input[name="v_id[]"]').val();
                // Get the variant ID from the hidden input field
                var comp = `
                    <div class="row mt-2">
                        <div class="col-sm-3">
        ...
        // Define a global object to cache dynamically added fields data
        ...
        function getComponentDataHtml(variantId, data) {
            return `
                <div class="row mt-2">
                    ...
                    <div class="col-sm-3">
                        <label for="inputName" class="col-form-label">Component Name</label>
                        <input type="text" name="component_name[${variantId}][]" class="form-control autocomplete" value="${data.component_name}">
                    </div>
                    <div class="col-sm-4">
                        <label for="inputValue" class="col-form-label">Component Value</label>
        ...
        function getEmptyKeyFeatureDescData(variantId) {
            return `<textarea name="key_features[${variantId}][]" class="form-control content" id="content"></textarea>`;
        }
        ...
        function getKeyFeatureDescDataHtml(variantId, data) {
            return `
                ...
                <textarea name="key_features[${variantId}][]" class="form-control content" id="content">${data.description}</textarea>`;
        }
    </script>
@endsection
