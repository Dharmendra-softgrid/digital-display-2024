      ...
      <form method="POST" action="{{route('product.store')}}" enctype="multipart/form-data">
        <div class="row">
          <div class="col-lg-12">
            ...
            @endif
            <div class="row mb-3">
              <label for="product_title" class="col-sm-2 col-form-label">Product Title <span style="color: red; font-size: small;">*</span></label>
              <div class="col-sm-10">
            ...
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Product Sub-Category <span style="color: red; font-size: small;">*</span></label>
              <div class="col-sm-10">
                  ...
                  <select class="form-select" name="series">
                      ...
                      @foreach ($series as $key => $value)
                          <option value="{{ $value->name }}"
                              @if (!empty($product->series)) {{ $product->series == $value->name ? 'selected="selected"' : '' }} @endif />
                          {{ $value->name }}</option>
                      @endforeach
                  </select>
            ...
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Industries <span style="color: red; font-size: small;">*</span></label>
              <div class="col-sm-10">
            ...
            <div class="row mb-3">
              <label for="variants" class="col-sm-2 col-form-label">Product Variant <span style="color: red; font-size: small;">*</span></label>
              <div class="col-sm-10">
                  <?php $svariants = isset($product->variants) ? $product->variants->pluck('variant')->toArray() : []; 
                  ?>
                  <select name="variant[]" class="form-control {{ $errors->has('variant') ? 'border-danger' : '' }}" id="variants" multiple>
                      @if($variants->isNotEmpty())
                          @foreach($variants as $variant)
                              <option value="{{ $variant->id }}" {{ in_array($variant->id, old('variant', $svariants)) ? 'selected' : '' }}>
                                  {{ $variant->name }}
                              </option>
                          @endforeach
                      @endif
            ...
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Short Description <span style="color: red; font-size: small;">*</span></label>
              <div class="col-sm-10">
            ...
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Product Main Image <span style="color: red; font-size: small;">*</span> (256 x 256 px)<br>
            ...
            <input type="file" name="featuredimage" id="featuredimage" class="d-none"
              ...
              <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Product Images <span style="color: red; font-size: small;">*</span> (466 × 450 px)</label>
                <div class="col-sm-10">
                ...
                <div class="card ">
                  ...
                  <div class="row comp-container">
                    <div class="col-sm-12 ">
                      ...
                      class="btn btn-primary btn-sm float-end addspeccomp mt-3"><i class="bi bi-plus"></i> Add
                      </button>
                    </div>
                    @if(isset($productComponents) && $productComponents->isNotEmpty())
                      @foreach($productComponents as $component)
                      <div class="row mt-2">
                        <div class="col-sm-3">
                            <label for="inputType" class="col-form-label">Component Type</label>
                            <input type="text" name="component_type[]" class="form-control autocomplete" value="{{$component->component_type}}">
                        </div>
                        <div class="col-sm-3">
                            <label for="inputName" class="col-form-label">Component Name</label>
                            <input type="text" name="component_name[]" class="form-control autocomplete"  value="{{$component->component_name}}">
                        </div>
                        <div class="col-sm-4">
                            <label for="inputValue" class="col-form-label">Component Value</label>
                            <input type="text" name="component_specification[]" class="form-control autocomplete"  value="{{$component->component_specification}}">
                        </div>
                        <div class="col-sm-2" style="margin-top:40px;"><button type="button" class="btn btn-danger btn-sm float-end deletecomp " data-toggle="modal" data-target="#confirmDeleteModal" data-id="{{ $component->id }}"><i class="bi bi-trash"></i></button></div>
                      </div>
                      @endforeach
                    @endif
                  </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <textarea name="key_features"
                  class="form-control {{$errors->has('description') ? 'border-danger' : '' }} content"
                  id="content">{{old('key_features',isset($product->key_features) ? $product->key_features : '' )}}</textarea>
            ...
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Key Feature Tile Section</label>
              <div class="col-sm-10" id="sectionSortable">
                <div class="row bimagec sectionunsortable">
                  <div class="col-sm-12 mb-3"><button type="button" class="btn btn-primary btn-sm float-end addblog"><i
                        class="bi bi-plus"></i> Add Section</button>
                  </div>
                </div>
                ...
                <div class="card ">
                  <div class="card-body">
                    <div class="row spece-container">
                      <div class="col-sm-12 "><button type="button" style="margin-bottom: 5px;"
                      ...
                      <div class="col-sm-3"><input type="file" name="pdf_files[]" multiple class="form-control"></div>
                      <label for="inputNumber" class="col-sm-2 col-form-label">Name</label>
                      <div class="col-sm-3"><input type="text" name="pdf_names[]" class="form-control"></div>
                      <div class="col-sm-2"><button type="button" class="btn btn-danger btn-sm float-end deletespec "><i class="bi bi-trash"></i></button></div>
                      
                    </div><br>
                    
                    <div class="row">
                      @if(!empty($productBrochures))
                          @foreach($productBrochures as $bs)
                              <div class="col-sm-3">
                                  <div class="card">
                                      <input type="hidden" name="brochures_id[]" value="{{$bs->id}}">
                                      <!-- <img class="specsheetimg" src="{{asset('specesheet/PDF_file_icon.webp')}}" alt="Card image cap"> -->
                                      <embed src="{{asset('specesheet/'.$bs->value)}}" width="50px" height="70px" />
                                      <div class="card-body mt-3 text-center">
                                          <a href="{{asset('specesheet/'.$bs->value)}}" class="card-link mt-3" target="_blank">{{$bs->value}}</a>
                                      </div>
                                      <div class="card-footer text-center">
                                          <button type="button" class="btn btn-danger btn-sm deletespecsheet " data-toggle="modal" data-target="#confirmDeleteModalPDFDelete" data-id="{{ $bs->id }}"><i class="bi bi-trash"></i></button>
                                      </div>
                                  </div>
                              </div>
                          @endforeach
...
<div class="modal fade" id="confirmDeleteModalPDFDelete" tabindex="-1" role="dialog" aria-labelledby="confirmDeleteModalPDFDeleteLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    $('.addspeccomp').click(function () {
    var comp = `<div class="row mt-2">
                    <div class="col-sm-3">
                        <label for="inputType" class="col-form-label">Component Type</label>
                        <input type="text" name="component_type[]" class="form-control autocomplete">
                    </div>
                    <div class="col-sm-3">
                        <label for="inputName" class="col-form-label">Component Name</label>
                        <input type="text" name="component_name[]" class="form-control autocomplete">
                    </div>
                    <div class="col-sm-4">
                        <label for="inputValue" class="col-form-label">Component Value</label>
                        <input type="text" name="component_specification[]" class="form-control autocomplete">
                    </div>
                    <div class="col-sm-2" style="margin-top:40px;"><button type="button" class="btn btn-danger btn-sm float-end deletecomp "><i class="bi bi-trash"></i></button></div>
              </div>`;
    $('.comp-container').append(comp);
});
