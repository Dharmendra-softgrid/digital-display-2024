                ...
                <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label"><span
                                    style="color: red; font-size: small;">*</span>Description</label>
                                <div class="col-sm-10">
                                    <textarea name="description" required class="form-control {{ $errors->has('description') ? 'border-danger' : '' }} content"
                            ...
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Product Key Features<span
                                    style="color: red; font-size: small;">*</span></label>
                                <div class="col-sm-10">
                                    <textarea name="keyfeatures" class="form-control {{ $errors->has('keyfeatures') ? 'border-danger' : '' }} content"
                                        id="content">{{ old('keyfeatures', isset($product->key_features) ? $product->key_features : '') }}</textarea>
                                    @if ($errors->has('keyfeatures'))
                                        <div class="text-danger">{{ $errors->first('keyfeatures') }}</div>
                                    @endif
                                </div>
                            </div>
                            <div class="row mb-3">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-5">
                                <label for="inputValue" class="col-form-label">Component Value</label>
                                 <textarea class="form-control autocomplete" name="component_specification[${variantId}][]"></textarea>
                            </div>
            ...
            <div class="card delcompt">
                <div class="card-body">
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-5">
                            <label for="inputValue" class="col-form-label">Component Value</label>
                            <textarea class="form-control autocomplete" name="component_specification[${variantId}][]">${data.component_specification}</textarea>
                        </div>
                        <div class="col-sm-1" style="margin-top:40px;">
