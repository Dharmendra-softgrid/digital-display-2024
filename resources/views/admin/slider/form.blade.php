                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-md-2 col-form-label">Title <span
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="title" class="form-control"
                                        value="{{ isset($slider->slide_title) ? $slider->slide_title : '' }}">
                                    @if ($errors->has('title'))
                                            ...
                                            <optgroup label="Pages">
                                                @foreach ($pages as $item)
                                                    <option value="{{ $item->slug }}"
                                                        @if (!empty($slider->type)) {{ $slider->type == $item->slug ? 'selected="selected"' : '' }} @endif />
                                                    {{ $item->title }}</option>
                                                @endforeach
                                            </optgroup>
                                        @endif
                          ...
                          <textarea name="meta_description" class="form-control">{{ old('meta_description', isset($successstory->meta_description) ? $successstory->meta_description : '') }}</textarea>
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-md-2 col-form-label">Content <span
                                        style="color: red; font-size: small;">*</span></label>
                                <div class="col-md-10">
                                    <textarea name="content" id="content" class="content">{{ isset($slider->slide_content) ? $slider->slide_content : '' }}</textarea>
                        ...
                        <div class="row mb-3">
                          <label for="inputEmail3" class="col-sm-2 col-form-label">Slide <span
                            style="color: red; font-size: small;">*</span><br> <!--<small style="font-size;11px;">(1920x640)</small>--></label>
                            <div class="col-sm-10">
                                <div class="card ">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#bannerimage').change(function() {
                ...
                if (sizeKB > 13000) {
                    $('.msg').html(
                        '<div class="text-danger">The banner image may not be greater than 13000 kilobytes</div>'
                    );
                    return;
