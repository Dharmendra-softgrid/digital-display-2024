            ...
            <div class="card-body">
              @include('admin.shared.displaymsg')
                <div class="d-flex justify-content-between mt-4">
                  ...
                  <div>
                  <a href="{{route('video.create')}}" class="btn btn-primary  "><i class="bi bi-plus"></i> Add Video</a>
                  </div>
                      ...
                      <tr>
                       ...
                       <td>
                        <video width="400px" height="200px" controls loop>
                          <source src="{{asset(isset($video->video) ? 'videos/'.$video->video : 'images/computerbanner.jpg')}}" type="video/mp4">
                        ...
                        <td>
                          ...
                          <a title="edit" href="{{route('video.edit',['id'=>$video->id])}}" class="btn btn-primary btn-sm " data-id="{{$video->id}}"><i class="bi bi-pencil"></i></a>
