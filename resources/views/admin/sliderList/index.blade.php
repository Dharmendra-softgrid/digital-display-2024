            ...
            <div class="card-body">
              @include('admin.shared.displaymsg')
                <div class="d-flex justify-content-between mt-4">
                  ...
                  <div>
                  <a href="{{route('sliderList.create')}}" class="btn btn-primary  "><i class="bi bi-plus"></i> Add Slide</a>
                  </div>
                    ...
                    @foreach($sliders as $i=>$slider)
                      <tr>
                        ...
                        <td>
                          ...
                          <a title="edit" href="{{route('sliderList.edit',['id'=>$slider->id])}}" class="btn btn-primary btn-sm " data-id="{{$slider->id}}"><i class="bi bi-pencil"></i></a>
...
<script type="text/javascript">
  var delid;
  var delurl="{{url('admin/sliderList')}}";
