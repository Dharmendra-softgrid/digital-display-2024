          ...
          <div class="row">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between mt-4">
                  ...
                  <div>
                  <a href="{{route('content.create')}}" class="btn btn-primary  "><i class="bi bi-plus"></i> Add Content</a>
                  </div>
                  ...
                  @if($contents->isNotEmpty())
                    @foreach($contents as $i=>$content)
                      <tr>
                        ...
                        <td>{{$content->title}}</td>
                        <td>
                          <!-- Generate the link using the 'contentList' route with the 'page' parameter -->
                          <a href="{{ route('contentList', ['type' => $content->page]) }}"> {{ $content->page }}</a>
                        </td>
                      </tr>
                    @endforeach
                  @else
