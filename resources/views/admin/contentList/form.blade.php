            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('contentList.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-10">
                                    <select class="form-select" name="section_type" id="dropdown">
                                        <option disabled>Select One...</option>
                                        <option value="first_sec_content"
                                            @if (isset($content->section_type)) {{ $content->section_type == 'first_sec_content' ? 'selected' : '' }} @endif>
                                            first_sec_content</option>
                                        <option value="second_sec_content"
                                            @if (isset($content->section_type)) {{ $content->section_type == 'second_sec_content' ? 'selected' : '' }} @endif>
                                            second_sec_content</option>
                                        <option value="third_sec_content"
                                            @if (isset($content->section_type)) {{ $content->section_type == 'third_sec_content' ? 'selected' : '' }} @endif>
                                            third_sec_content</option>
                                        <option value="fourth_sec_content"
                                            @if (isset($content->section_type)) {{ $content->section_type == 'fourth_sec_content' ? 'selected' : '' }} @endif>
                                            fourth_sec_content</option>
                                        <option value="fifth_sec_content"
                                            @if (isset($content->section_type)) {{ $content->section_type == 'fifth_sec_content' ? 'selected' : '' }} @endif>
                                            fifth_sec_content</option>
                                        <option value="sixth_sec_content"
                                            @if (isset($content->section_type)) {{ $content->section_type == 'sixth_sec_content' ? 'selected' : '' }} @endif>
                                            sixth_sec_content</option>
                                        <option value="seventh_sec_content"
                                            @if (isset($content->section_type)) {{ $content->section_type == 'seventh_sec_content' ? 'selected' : '' }} @endif>
                                            seventh_sec_content</option>
                                        <option value="eighth_sec_content"
                                            @if (isset($content->section_type)) {{ $content->section_type == 'eighth_sec_content' ? 'selected' : '' }} @endif>
                                            eighth_sec_content</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-md-2 col-form-label">Page <span
                                            ...
                                            <optgroup label="Pages">
                                                @foreach ($pages as $item)
                                                    <option value="{{ $item->slug }}"
                                                        @if (!empty($content->page)) {{ $content->page == $item->slug ? 'selected="selected"' : '' }} @endif />
                                                    {{ $item->title }}</option>
                                                @endforeach
                                            </optgroup>
                                        @endif
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        @include('admin.shared.addvideo', [
                            'videos' =>
                                isset($successstory) && $successstory->videos->isNotEmpty()
                                    ? $successstory->videos
                                    : '',
                        ])
                      </div>
                      ...
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Slide <br> <!--<small style="font-size;11px;">(1920x640)</small>--></label>
                            <div class="col-sm-10">
                                <div class="card ">
                                    ...
                                    <img src="{{ asset(isset($content->image) ? 'images/' . $content->image : 'images/computerbanner.jpg') }}"
                                        class="banner-img" alt="..." id="bannerimagepreview">
                                    <div class="card-body text-center ">
                                ...
                                @if ($errors->has('bannerimage'))
                                    <div class="text-danger">
                                        {{ str_replace('bannerimage', 'banner image', $errors->first('bannerimage')) }}</div>
                                @endif
                                <div class="msg"></div>
                            </div>

                    </div>
                    <input type="file" name="bannerimage" id="bannerimage" class="d-none"
                  ...
                  <div class="col-sm-10">               
                    ...
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Banner <br>
                        ...
                        <div class="col-sm-10">
                            <div class="card ">
                                ...
                                <img src="{{ asset(isset($content->image) ? 'images/' . $content->image : 'images/computerbanner.jpg') }}"
                                    class="banner-img" alt="..." id="bannerimagepreview">
                                <div class="card-body text-center ">
                                    <button type="button" class="btn btn-primary btn-sm mt-3 " id="addbannerimage"><i
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#bannerimage').change(function() {
                ...
                if (sizeKB > 20480) {
                    $('.msg').html(
                        '<div class="text-danger">The banner image may not be greater than 20480 kilobytes</div>'
                        );
                    return;
