        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto main_menu">
                        ...
                        <div class="dropdown-menu second_level_menu">
                            <ul class="navbar-nav-menu display-style">
                                @foreach ($industries as $i)
                                    <li class="nav-item">
                                        <a class="dropdown-item {{ request()->route()->named('industry') && request()->route('slug') == $i->slug ? 'active' : '' }}"
                                            href="{{ route('industry', ['slug' => $i->slug]) }}">{{ $i->title }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link {{ request()->is('success-stories') ? 'active' : '' }}"
                            href="{{ route('success-stories') }}">Success Stories</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('news-and-blogs') ? 'active' : '' }}"
                            href="{{ route('news-and-blogs') }}">NEWS & BLOGS</a>
                    </li>
                </ul>
                <ul class="navbar-nav ml-auto right-nav inquire-now-menu mobile_hide">
                    ...
                    <li class="nav-item">
                        <a class="inquire-now-link {{ request()->is('inquire-now') ? 'active' : '' }}"
                            href="{{ route('inquire-now') }}">ENQUIRE NOW</a>
                    </li>
                </ul>
        ...
        <div class="Search_bar">
            <form class="form-inline" action="{{ route('search') }}" method="GET">
                <input class="form-control me-2" name="query" type="search" placeholder="Search"
                    aria-label="Search">
                <button class="btn btn-outline-secondary" type="submit"><img class="black-search"
                        src="{{ asset('/') }}images/Searchblack.svg"></button>
            </form>
