                                                        ...
                                                        @foreach($child->children as $subChild)
                                                            ...
                                                            @if(!empty($subChild->page) && $subChild->page != null && $subChild->page != 0)
                                                                <li class="menu-text-case"> 
                                                                  <a id="{{$subChild->slug}}" class="dropdown-item  {{ request()->url() == route('displaysolutions', ['slug' => $subChild->slug]) ? 'active' : '' }}" href="{{route('displaysolutions', ['slug' => $subChild->slug])}}">{{$subChild->title}}</a>
